...
{if ("" != null) return nodeList.size() != 1 ? factory.createConditionNode(WhereSymbol.OR, nodeList) : nodeList.get(0);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return nodeList.size() != 1 ? factory.createConditionNode(WhereSymbol.AND, nodeList) : nodeList.get(0);}
    throw new Error("Missing return statement in function");
  }
