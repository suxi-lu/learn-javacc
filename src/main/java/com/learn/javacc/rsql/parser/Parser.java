package com.learn.javacc.rsql.parser;/* Parser.java */
...
final class Parser implements ParserConstants {
    ...
    public Parser(InputStream stream, String encoding, NodeFactory factory) {
...
{if ("" != null) return nodeList.size() != 1 ? factory.createWhereNode(WhereSymbol.OR, nodeList) : nodeList.get(0);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return nodeList.size() != 1 ? factory.createWhereNode(WhereSymbol.AND, nodeList) : nodeList.get(0);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return node;}
  ...
  final public ConditionNode Condition() throws ParseException {final String fieldName;
    final String operate;
    final List<String> value;
    fieldName = Selector();
    operate = Operator();
    value = Arguments();
{if ("" != null) return factory.createComparisonNode(fieldName, operate, value);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return Arrays.asList((String) value);}
  ...
  final public List<String> ConditionArguments() throws ParseException {final List<String> list = new ArrayList<String>(3);
    String arg;
    arg = Argument();
list.add(arg);
    label_3:
...
/** Get the specific Token. */
  ...
  /** Generate com.learn.javacc.rsql.parser.ParseException. */
